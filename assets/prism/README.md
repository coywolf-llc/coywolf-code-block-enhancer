...
- `prism-*.min.js` — individual language grammars, enqueued on demand only for
  the languages a page actually uses.

These are third-party, upstream-minified assets; no build step is performed by
this plugin. To update, download the same component set at the desired version
from prismjs.com and replace these files in place.
